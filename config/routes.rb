ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :flags, :only => [ :new, :create ]
  ...
  map.resources :users, :member => { :show_admin => :get, :clear_avatar => :post, :reset_password => :post, :update_avatar => :post }, :collection => { :list => :get }
