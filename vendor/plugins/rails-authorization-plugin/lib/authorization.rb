    ...
    module ControllerInstanceMethods
      ...
      def handle_redirection
        ...
        if @current_user && @current_user != :false
          flash[:error] = @options[:permission_denied_message] || "Permission denied. You cannot access the requested page."
          redirect_to @options[:permission_denied_redirection] || PERMISSION_DENIED_REDIRECTION
        else
          flash[:error] = @options[:login_required_message] || "Login is required to access the requested page."
