...
module ApplicationHelper
  ...
  # The follow methods are for dealing with complex forms
  # See Ryan Bates
  ...
  def new_child_fields_template(form_builder, association, options = {})
    options[:object] ||= form_builder.object.class.reflect_on_association(association).klass.new #if form_builder.object
