      ...
      context "on POST to :give" do
        ...
        context "on a gift certificate you don't own" do
          setup do
            ...
            post :give, :id => @gift_certificate, :to_user => @to_user.login, :comments => 'hello'
          end
          should_assign_to :gift_certificate
        ...
        context "with a bogus user" do
          setup do
            post :give, :id => @gift_certificate, :to_user => 'xyz'
          end
          should_assign_to :gift_certificate
          should_respond_with :success
        ...
        context "specifying user" do
          setup { post :give, :id => @gift_certificate, :to_user => @to_user.login, :comments => 'hello' }
